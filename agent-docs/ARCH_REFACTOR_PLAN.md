...
- [x] App (`rabbit-digger-pro`) may depend on Core and a _bundle_ crate; avoid direct dependencies on individual protocol crates.
...
- [x] Re-map existing features in `rabbit-digger-pro` to enable corresponding features in `rdp-bundle`.
